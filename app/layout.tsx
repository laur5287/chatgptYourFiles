				...
				<Providers>
					<div className="flex flex-col items-center h-full">
						<nav className="flex justify-center w-full border-b border-b-foreground/10">
							<div className="flex items-center justify-end max-w-6xl text-sm grow text-foreground">
								<div className="flex flex-row grow">
									<Link
										href="/"
										className="px-6 py-4 font-bold cursor-pointer hover:bg-slate-100"
									>
										<svg
											width="20px"
											height="20px"
								...
								<div className="flex flex-row">
									{user ? (
										...
										<Link
											href="/login"
											className="px-6 py-4 no-underline rounded-md bg-btn-background hover:bg-btn-background-hover"
										>
											Login
										</Link>
									)}
